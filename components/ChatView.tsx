...
import { Group, Message as MessageType, MessageType as MsgEnum } from '../types';
...
const ChatView: React.FC<ChatViewProps> = ({ group, isSyncing, isConnected, onSendMessage, justSentMessageIds, onBack }) => {
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-zinc-900">
      ...
      {isSyncing && (
          <div className="px-6 pb-2 text-sm text-lime-400 flex items-center justify-center animate-pulse">
      ...
      <div className="p-2 border-t border-zinc-800 bg-zinc-900">
        <MessageInput onSendMessage={onSendMessage} disabled={!isConnected || isSyncing} />
      </div>
