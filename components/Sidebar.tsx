...
import { Group, Invitation, User } from '../types';
    ...
    >
        <div className="flex items-center space-x-4">
            ...
            <div className="flex-1">
                ...
                <p className="text-sm text-zinc-400 truncate max-w-[200px]">{group.messages[group.messages.length - 1]?.content || 'File attached'}</p>
            </div>
        </div>
        {group.unreadCount > 0 && (
...
const GroupListView: React.FC<GroupListViewProps> = ({ currentUser, groups, onSelectGroup, isConnected, setIsConnected, onOpenCreateGroupModal, onOpenProfileModal, invitations, onAcceptInvitation, onDeclineInvitation }) => {
  return (
